        ...
        <tr>
            ...
            <td>
                <form action="{{route('admin.pitch.destroy',$each)}}" method="post">
                    ...
                    @csrf
                    @method('delete')
                    <button id="delete-button-field" class="btn btn-secondary" type="button" data-toggle="modal" data-target="#danger-header-modal" onClick="deletePitch({{ $each->id  }})" >Xóa</button>
                </form>
